<template>
    <div class="viewer-container">
      <div>
        ...
        <el-dialog v-model="reportModalVisible" title="Generate File Upload History Report" width="30%" center
          :close-on-click-modal="false" :close-on-press-escape="false" @close="resetDatePickers">
          <div class="modal-content">
            ...
            <el-date-picker v-model="fromDatePicker" type="date" format="YYYY-MM-DD" value-format="YYYY-MM-DD"
              placeholder="From Date" :disabled-date="disableFromDate" style="margin-right: 10px; margin-bottom: 10px;" />
            <el-date-picker v-model="toDatePicker" type="date" format="YYYY-MM-DD" value-format="YYYY-MM-DD"
              placeholder="To Date" :disabled-date="disableToDate" style="margin-right: 10px;" />
  ...
  const resetDatePickers = () => {
    ...
    dateErrorMessage.value = ''; // Optionally clear any error messages as well
  };
